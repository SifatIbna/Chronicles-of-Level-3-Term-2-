...
END {
    ...
    if (simulation_time == 0){
        print "0",",",(total_delay / received_packets),",",(received_packets / sent_packets),",",(dropped_packets / sent_packets);
    }

    else if(sent_packets == 0){
        print (received_bytes * 8) / simulation_time,",",(total_delay / received_packets),",","0",",","0";
    }

    else if(received_packets ==0){
        print (received_bytes * 8) / simulation_time,",","0",",",(received_packets / sent_packets),",",(dropped_packets / sent_packets);
    }
